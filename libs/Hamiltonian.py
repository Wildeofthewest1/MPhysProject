...
class Hamiltonian(object):
	...
	def __init__(self, Isotope, Trans, gL, Bfield, AgIsotopeShift = None):
		...
		if atom_transition == ac.Ag107_D2 and AgIsotopeShift != None:
			self.groundManifold, self.groundEnergies = self.groundStateManifold(atom.gI,atom.I,atom.As,
									AgIsotopeShift[0],Bfield)
		elif atom_transition == ac.Ag109_D2 and AgIsotopeShift != None:
			self.groundManifold, self.groundEnergies = self.groundStateManifold(atom.gI,atom.I,atom.As,
									AgIsotopeShift[1],Bfield)
		else:
			self.groundManifold, self.groundEnergies = self.groundStateManifold(atom.gI,atom.I,atom.As,
